                ...
                <div class="col-lg-12 col-xl-7">
                  <div class="card">
                    <div class="card-body p-5">
                      ...
                      <h2>
                        Hey sir {{ Auth::user()->name }},
                      </h2><br>
                      <p class="fs-sm">
                        This is the invoice for a payment of <strong>${{ $orders_invoice_name->Total_price }}</strong> USD 
                      </p>
                      ...
                      <div class="border-top border-gray-200 pt-4 mt-4">
                        <div class="row">
                          <div class="col-md-6">
                            ...
                            <strong>#{{ $orders_invoice_name->order_id }}</strong>
                          </div>
                          <div class="col-md-6 text-md-end">
                            <div class="text-muted mb-2">Invoice Date</div>
                            <strong>{{ $orders_invoice_name->created_at }}</strong>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6 text-md-end">
                            ...
                            <p class="fs-sm">
                              ...
                              <br>
                              <a href="#!" class="text-purple">hamadelshabrawi@email.com
                              </a>
                            </p>
                          </div>
                        </div>
                      ...
                      <table class="table border-bottom border-gray-200 mt-3">
                        <thead>
                          <tr>
                            ...
                            <th scope="col" class="fs-sm text-dark text-uppercase-bold-sm text-end px-0">Discount</th>
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td class="px-0">{{ $orders_invoice->product_title }}</td>
                            <td class="text-end px-0">{{ $orders_invoice->product_quantity }}</td>
                            <td class="text-end px-0">{{ $orders_invoice->product_sale_price }}</td>
                            <td class="text-end px-0">{{ $orders_invoice->product_discount }}</td>
                      ...
                      <div class="mt-5">
                        <div class="d-flex justify-content-end">
                          <p class="text-muted me-3">Subtotal:</p>&ensp;
                          <span>${{ $price }}</span>
                        </div>
                        @if ( $totalDiscount  > 1)
                        <div class="d-flex justify-content-end">
                          <p class="text-muted me-3">Discount:</p>&ensp;
                        ...
                        <div class="d-flex justify-content-end mt-3">
                          ...
                          <h5 class="text-success">$ {{ $totalDiscount }} USD</h5>
                        </div>
                      </div>
                    </div>

                    <a href="{{ url('send',$orders_invoice->user_id) }}" class="btn btn-dark btn-lg card-footer-btn justify-content-center text-uppercase-bold-sm hover-lift-light">
