                             ...
                             <form action="{{ url('add_cart',$productss->id) }}" method="post" >
                                   ...
                                   @if (!$productss->quantity < 1 )
                                      <div class="row" style="margin-top:50px ;">
                                         <div class="col-sm-4">
                                            <input style="width:80px ;" placeholder="Qty" type="number" min="1" max="{{ $productss->quantity }}" name="cartQty" value="">
                                         </div>
                                         <div class="col-sm-4">
                                            <input href="" style="height:40px;line-height: 10px;" type="submit" class="option1" value="Add To Card">
                                         </div>
                                      </div>
                                   @else
                                   <div class="row" style="margin-top:50px ;">
